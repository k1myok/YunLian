...
namespace Apache.WorkFlow {
    ...
    public partial class ItService : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        private System.Activities.InArgument<Apache.Models.WorkFlowInParameter> _WfIn;
...
partial void AfterInitializeComponent();
        ...
        public System.Activities.InArgument<Apache.Models.WorkFlowInParameter> WfIn {
            get {
                return this._WfIn;
            }
            set {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(ItService).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(ItService));
        ...
        private string FindResource() {
            string[] resources = typeof(ItService).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".ItService_bak.g.xaml") || resource.Equals("ItService_bak.g.xaml"))) {
                    return resource;
                }
            }
